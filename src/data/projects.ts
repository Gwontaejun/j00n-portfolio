...
export const workProjects: PortfolioProject[] = [
  {
    ...
    technologies: ["React", "TypeScript", "Zustand", "Chart.js", "deck.gl", "Mapbox GL"],
    features: [
      { title: "공간 데이터 시각화", description: "Mapbox GL과 deck.gl 레이어를 결합해 이동·체류 데이터를 지도에 표현했습니다." },
      { title: "H3 셀 및 3D 건물", description: "H3 기반 영역 집계와 3D 건물 레이어로 지역별 데이터를 입체적으로 탐색하도록 구성했습니다." },
      { title: "렌더링 최적화", description: "초 단위 상태 갱신과 레이어 연산을 메모이제이션해 지도 렌더링 부하를 줄였습니다." },
      { title: "CES 2025 대응", description: "전시 일정에 맞춰 서비스 완성도와 현장 시연 안정성을 개선했습니다." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "운영 통계 대시보드", description: "메뉴별 진입 수, 체류 시간, 기능 사용량을 한 화면에서 확인하도록 구현했습니다." },
      { title: "사용자 관리", description: "회원 정보를 조회하고 운영에 필요한 관리 기능을 구성했습니다." },
      { title: "데이터셋 관리", description: "서비스에서 사용하는 데이터셋을 조회하고 관리하는 화면을 개발했습니다." },
      { title: "로그 조회", description: "운영 이슈를 추적할 수 있도록 서비스 로그 조회 흐름을 구현했습니다." },
    ],
    image: "/web-project/work-project.svg",
    accent: "#7c3aed",
  },
  {
    ...
    technologies: ["React", "TypeScript", "Redux", "Redux-Saga", "Ant Design", "Axios"],
    features: [
      { title: "커리어 프로필", description: "개인의 기술과 경력 정보를 확인하고 관리하는 화면을 구현했습니다." },
      { title: "조직 이동 및 과제", description: "조직 이동, 지원 요청, 과제 배정에 필요한 업무 흐름을 개발했습니다." },
      { title: "비동기 상태 관리", description: "Redux-Saga로 API 호출과 인증이 포함된 비동기 흐름을 구성했습니다." },
      { title: "공통 UI 체계", description: "Atomic Design과 Axios 인터셉터를 적용해 화면과 통신 로직의 일관성을 높였습니다." },
    ],
    image: "/web-project/work-project.svg",
    accent: "#8b5cf6",
  },
  {
    ...
    technologies: ["Next.js 13", "React", "TypeScript", "Recoil", "SSR", "SSG", "ISR"],
    features: [
      { title: "프론트엔드 리딩", description: "업무 분배와 일정을 관리하고 협력사와 개발 범위를 조율했습니다." },
      { title: "렌더링 전략", description: "페이지 성격에 맞춰 SSR, SSG, ISR을 구분해 적용했습니다." },
      { title: "검색 노출 개선", description: "Next.js 메타데이터와 렌더링 방식을 활용해 SEO 기반을 정비했습니다." },
      { title: "반응형 홈페이지", description: "기업 및 채용 콘텐츠를 다양한 화면에서 일관되게 제공하도록 구현했습니다." },
    ],
    image: "/web-project/work-project.svg",
    accent: "#0891b2",
  },
  {
    ...
    features: [
      { title: "맞춤형 대시보드", description: "위젯을 이동하고 배치해 사용자별 관제 화면을 구성하도록 구현했습니다." },
      { title: "지도 기반 탐색", description: "검색과 마커 기능을 연동해 충전소 위치와 상태를 빠르게 확인하도록 했습니다." },
      { title: "복잡한 폼 최적화", description: "메모이제이션을 적용해 입력 항목이 많은 관리 화면의 렌더링 성능을 개선했습니다." },
    ],
    image: "/web-project/work-project.svg",
    accent: "#059669",
  },
  {
    ...
    features: [
      { title: "웹 접근성", description: "웹와치 접근성 평가 100%를 달성할 수 있도록 인터페이스를 개선했습니다." },
      { title: "다국어 지원", description: "해외 운영 환경을 고려해 i18n 기반의 다국어 구조를 적용했습니다." },
      { title: "지도 기반 관제", description: "Google Maps 검색과 마커를 연결해 충전소 탐색 기능을 구현했습니다." },
      { title: "화면 성능 개선", description: "상태와 컴포넌트 렌더링을 메모이제이션해 관제 화면의 반응성을 높였습니다." },
    ],
    image: "/web-project/work-project.svg",
    accent: "#0d9488",
  },
